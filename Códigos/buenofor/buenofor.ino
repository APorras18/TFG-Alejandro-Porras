...
void loop()
{
   ...
   if ((Xv <300) && (Yv <300)) //Arriba izquierda
    ...
    {
     ejex(5,LOW);  //Pongo 5 por ser un movimiento recto
    ...
    else if ((Xv<300) && (301<Yv<699))  //Centro izquierda
    {
     ...
     ejey(5,LOW);  //Pongo 5 por ser un movimiento recto
    }
    ...
    {
     ejex(1,LOW);  //Pongo 0 porque no se mueve en el eje X
     ejey(5,HIGH); //Cambio a HIGH por ser hacia el otro sentido del movimiento
    }  
